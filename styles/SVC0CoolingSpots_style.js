...
var style_SVC0CoolingSpots = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3; 
        ...
        stroke: new ol.style.Stroke({color: 'rgba(31,65,180,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2.508}),
