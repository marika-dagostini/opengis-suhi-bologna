...
var style_SVC0WarmingSpots = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3; 
        ...
        stroke: new ol.style.Stroke({color: 'rgba(168,0,0,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2.508}),
